...
public class Menu {
    ...
    public static void displaymenu()
    {
        ...
        System.out.println("7. 오래된 생성 날짜순 정렬 ( ls_date )");
        System.out.println("8. 최근 생성 날짜순 정렬 ( ls_date_desc )");
        System.out.println("9. 키워드 검색 ( find <Keyword>)");
        System.out.println("10. 카테고리 키워드 검색 ( find_cate <Keyword>)");
